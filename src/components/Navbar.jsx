...
const Navbar = () => {
  ...
  return (
    <div className="w-full flex justify-center items-center fixed z-30">
      <nav className="w-full flex justify-center items-center p-2 relative ">
        <div className="w-4/5 flex justify-between items-center p-3 bg-white border-2 border-dashed border-slate-700 rounded-lg">
          <div>
            <p className="font-semibold text-2xl">Dev-Kaung</p>
          </div>
          ...
          <div className="mobile:hidden">
            <button className="p-1 px-2 rounded-lg bg-[#ffbd59] text-white hover:scale-100 transition-all duration-150">
              Hire me
            </button>
          </div>
